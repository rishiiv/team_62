 ...
 * Boba Shop POS - main window shell with role toggle and status bar.
 */
public class MainView extends BorderPane {
    ...
    private void setupLayout() {
        ...
        // Header with app title and role toggle
        ...
        // Placeholder center content; real content is provided by the window controller
        ...
        placeholder.getChildren().addAll(welcome, new Separator(),
                new Label("This demo shows both day-to-day cashier ordering and manager workflows."));
